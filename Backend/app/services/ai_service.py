...
class AIService:
    def __init__(self):
        ...
        try:
            ...
            self.ready = True
            print("[OK] Groq AI service initialized successfully")
        except Exception as e:
            print(f"[ERROR] Failed to initialize Groq AI service: {e}")
            self.client = None
            self.ready = False
...
Please respond as a compassionate mental wellness assistant. Be empathetic, supportive, and offer hope. Mix English and Hindi naturally. Keep it conversational and warm (2-3 sentences max)."""
            ...
            print(f"[WARNING] Reply generation error: {e}")
            import random
            return random.choice(self.fallback_responses)
...
Emotion: {emotion}"""
            ...
            print(f"[WARNING] Suggestions generation error: {e}")
