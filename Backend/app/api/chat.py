...
from ..services.chat_service import get_user_chat_history, process_user_message
...
async def get_chat_history(user_id: str):
    ...
    try:
        ...
        messages = await get_user_chat_history(user_id)
...
async def websocket_endpoint(websocket: WebSocket, user_id: str):
    ...
    try:
        while True:
            ...
            if user_message:
                # Call the simplified service function
                await process_user_message(user_id, user_message)
